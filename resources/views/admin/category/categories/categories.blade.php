                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="{{ route('add_category') }}" class="btn btn-primary"><i class="fas fa-folder-plus"></i> Add New Category</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr id="category-{{ $category->id }}">
                                                <td>{{ $key + 1 }}</td>
                                                <td><img src="{{ asset($category->image) }}" class="img-fluid" style="width: 40px;" alt=""></td>
                                                <td>{{ $category->name }}</td>
